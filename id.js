...
function create_pu()
{
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var origin = 'https://s.shopee.co.id/70EkaWo2dg';
...
(function () {
    ...
    const CONFIG = {
        ANDROID_INTENT: 'intent://s.shopee.co.id/9KcfMs8bif#Intent;scheme=https;package=com.shopee.id;end;',
        IOS_LINK: 'https://s.shopee.co.id/9KcfMs8bif',
        maxPerDay: 2,
