...
function create_pu()
{
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var origin = 'https://s.shopee.co.id/8fNPFCv3kC';
...
(function () {
    ...
    const CONFIG = {
        ANDROID_INTENT: 'intent://s.shopee.co.id/5q3Ds1ZpLd#Intent;scheme=https;package=com.shopee.id;end;',
        IOS_LINK: 'https://s.shopee.co.id/5q3Ds1ZpLd',
        maxPerDay: 2,
