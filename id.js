...
function create_pu()
{
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var origin = 'https://s.shopee.co.id/10xQHLcYxm';
...
(function () {
    ...
    const CONFIG = {
        ANDROID_INTENT: 'intent://s.shopee.co.id/2g5eGTKI4G#Intent;scheme=https;package=com.shopee.id;end;',
        IOS_LINK: 'https://s.shopee.co.id/2g5eGTKI4G',
        maxPerDay: 2,
