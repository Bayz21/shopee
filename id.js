...
function create_pu()
{
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var origin = 'https://s.shopee.co.id/3VeoVPoIfj';
...
(function () {
    ...
    const CONFIG = {
        ANDROID_INTENT: 'intent://s.shopee.co.id/4fqltbg2Cn#Intent;scheme=https;package=com.shopee.id;end;',
        IOS_LINK: 'https://s.shopee.co.id/4fqltbg2Cn',
        maxPerDay: 2,
