...
function create_pu()
{
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var origin = 'https://s.shopee.co.id/60M5cUM6Lh';
...
(function () {
    ...
    const CONFIG = {
        ANDROID_INTENT: 'intent://s.shopee.co.id/5VPp1fv7fG#Intent;scheme=https;package=com.shopee.id;end;',
        IOS_LINK: 'https://s.shopee.co.id/5VPp1fv7fG',
        maxPerDay: 2,
